        ...
        <View className='gap-10'>
            ...
            <View className='gap-5'>
                ...
                <View className='gap-3'>
                    ...
                    <Text style={{fontSize: hp(1.6)}} className='text-right font-semibold text-neutral-500'>Forgot Password?</Text>
                </View>
            </View>
            ...
            <View>
                {
                    loading ? (
                        ...
                        <TouchableOpacity style={{ height: hp(6) }} className='bg-indigo-500 rounded-xl justify-center items-center' onPress={handleLogin}>
            ...
            <View className='flex-row justify-center'>
                <Text style={{ fontSize: hp(1.7) }} className='font-semibold text-nuetral-500'>Don't have an account? </Text>
                <Pressable onPress={() => router.push('signup')}>
                    <Text style={{ fontSize: hp(1.7) }} className='font-bold text-indigo-500'>Sign Up</Text>
                </Pressable>
            </View>
        </View>
      </View>
